...
/**
 * An Id object for {@link MetadataVoteByIp}
 *
 * @author Pete
 */
@Embeddable
@Access(AccessType.PROPERTY)
public class MetadataVoteByIpId implements Serializable {

    private static final long serialVersionUID = 2793801901686171677L;
     ...
     * @param ipAddress the id of the user making the vote.
     */
    public MetadataVoteByIpId(int metatatId, String ipAddress) {
    ...
    /**
     * Get the IP Address of the user the vote is related to.
     *
     * @return the IP Address of the user the vote is related to.
     */
    ...
    /**
     * Set the IP Address of the user the vote is related to.
     *
     * @param ipAddress the IP Address of the user the vote is related to.
     */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        MetadataVoteByIpId other = (MetadataVoteByIpId) obj;
        if (_ipAddress == null) {
